...
<head>
	...
	<body>
	   <div id="sum">
	      <form action="allsong" method="post" id="form">
		  ...
		  <div id="tid">
		  	<table>
		  		...
		  		<c:forEach items="${list}" var="song" varStatus="sta">
		  			...
		  			<td>${song.time }</td>
		  			<td>
		  				<a href="play?songId=${song.songId}">播放</a>
		  				<a href="download?songId=${song.songId}">下载</a>
		  				<a href="addcollection?songId=${song.songId}" >收藏</a>
		  			</td>
		  		</tr>
		  		</c:forEach>
		  	</table>
